...
# Parsing + Configuration Script – HKT-FNC63 - Rev. A

This **Parsing + Configuration** script is designed for the **HKT-FNC63** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – HKT-FNC63 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **HKT-FNC63** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
